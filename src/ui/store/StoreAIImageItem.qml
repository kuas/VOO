...
Item {
    ...
    Rectangle {
        ...
        Text {
            text: qsTr("Import AI Image")
            width: parent.width
            height: 20
            anchors {
                horizontalCenter: parent.horizontalCenter
                top: add_ai_icon.bottom
            }
    ...
    Rectangle {
            ...
            onPositionChanged: {
                ...
                if (dragEnable()) {
                    Logic.onPositionChanged(iconContainer.capture,
                                            ...
                                            startMouseX, startMouseY, "AIIMAGE")
                }
            }
            onReleased: {
                if (mouse.button !== Qt.LeftButton) {
                ...
                if (!isMove) {
                    aiImageLocalList.focus = true
                    aiImageLocalList.selectIndex = index
                }
                if (dragEnable()) {
                    ...
                    if (Logic.onReleased(
                                ...
                                storeDragWindow, mouse, 0,
                                selectCount > 0 ? aiImageLocalList.selectList : [index])) {
                        aiImageLocalList.focus = false
                    }
                }
            }
        }
        ...
        Image {
            ...
            MouseArea {
                ...
                onClicked: {
                    aiImageLocalList.focus = false
                    datasource.addLocalAIImageResource([index])
                }
            }
        }
    }
